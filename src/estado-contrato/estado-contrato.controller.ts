...
export class EstadoContratoController {
  ...
  @ApiResponse({ status: 201, description: 'El estado de contrato ha sido creado exitosamente.', type: EstadoContrato })
  ...
  @ApiResponse({ status: 200, description: 'Devuelve todos los estados de contrato.', type: [EstadoContrato] })
  findAll() {
  ...
  @ApiResponse({ status: 200, description: 'Devuelve el estado de contrato.', type: EstadoContrato })
  @ApiResponse({ status: 404, description: 'Estado de contrato no encontrado.' })
  ...
  @ApiResponse({ status: 200, description: 'El estado de contrato ha sido actualizado exitosamente.', type: EstadoContrato })
  @ApiResponse({ status: 400, description: 'Solicitud incorrecta.' })
  @ApiResponse({ status: 404, description: 'Estado de contrato no encontrado.' })
  update(
    @Param('id') id: string,
  ...
  @ApiParam({ name: 'id', type: 'string' })
  @ApiResponse({ status: 200, description: 'El estado de contrato ha sido eliminado exitosamente.' })
  @ApiResponse({ status: 404, description: 'Estado de contrato no encontrado.' })
  ...
  @ApiResponse({ status: 200, description: 'Devuelve los estados de contrato para el contrato especificado.', type: [EstadoContrato] })
  @ApiResponse({ status: 404, description: 'No se encontraron estados de contrato para el contrato especificado.' })
  ...
  @ApiParam({ name: 'contratoId', type: 'string' })
  @ApiResponse({ status: 200, description: 'Devuelve el estado actual del contrato especificado.', type: EstadoContrato })
  @ApiResponse({ status: 404, description: 'No se encontró estado actual para el contrato especificado.' })
