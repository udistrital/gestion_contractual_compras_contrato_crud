...
INSERT INTO documento_contrato (
    ...
    fecha_modificacion
      ...
      (uuid_generate_v4(), 1, 101, 1, 'ROL', 501, 'DOC-2024-001', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 1, 102, 1, 'ROL', 502, 'DOC-2024-002', true, true, NOW(), NOW()),
      (uuid_generate_v4(), 2, 103, 1, 'ROL', 503, 'DOC-2024-003', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 2, 104, 1, 'ROL', 504, 'DOC-2024-004', true, true, NOW(), NOW()),
      (uuid_generate_v4(), 3, 105, 1, 'ROL', 505, 'DOC-2024-005', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 3, 106, 1, 'ROL', 506, 'DOC-2024-006', true, true, NOW(), NOW()),
      (uuid_generate_v4(), 4, 107, 1, 'ROL', 507, 'DOC-2024-007', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 4, 108, 1, 'ROL', 508, 'DOC-2024-008', true, true, NOW(), NOW()),
      (uuid_generate_v4(), 5, 109, 1, 'ROL', 509, 'DOC-2024-009', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 5, 110, 1, 'ROL', 510, 'DOC-2024-010', true, true, NOW(), NOW()),
      (uuid_generate_v4(), 6, 111, 1, 'ROL', 511, 'DOC-2024-011', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 6, 112, 1, 'ROL', 512, 'DOC-2024-012', true, true, NOW(), NOW()),
      (uuid_generate_v4(), 7, 113, 1, 'ROL', 513, 'DOC-2024-013', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 7, 114, 1, 'ROL', 514, 'DOC-2024-014', true, true, NOW(), NOW()),
      (uuid_generate_v4(), 8, 115, 1, 'ROL', 515, 'DOC-2024-015', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 8, 116, 1, 'ROL', 516, 'DOC-2024-016', true, true, NOW(), NOW()),
      (uuid_generate_v4(), 9, 117, 1, 'ROL', 517, 'DOC-2024-017', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 9, 118, 1, 'ROL', 518, 'DOC-2024-018', true, true, NOW(), NOW()),
      (uuid_generate_v4(), 10 119,, 1, 'ROL', 519, 'DOC-2024-019', false, true, NOW(), NOW()),
      (uuid_generate_v4(), 10 120,, 1, 'ROL', 520, 'DOC-2024-020', true, true, NOW(), NOW());
